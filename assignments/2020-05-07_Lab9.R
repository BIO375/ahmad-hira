...
install.packages(c("broom", "dbplyr", "modelr", "pillar", "rlang", "tibble", "tidyr", 
                   "xml2"))

library(readr)
chap16e1FlippingBird <- read_csv("datasets/abd/chapter16/chap16e1FlippingBird.csv")
View(chap16e1FlippingBird)
